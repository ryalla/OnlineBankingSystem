...
<div id="account_details" class="form" style="width:100%;height:auto;overflow: scroll;max-height: 400px "> 
 <span style="color: #33b5e5; font-family: cursive; font-size:xx-large;">Available Balance</span> 
<table  style="width:100%;" >
 <thead>
	  <tr>
	    <th class="align_center">Account Number</th>
  ...
  <tbody>
	  ...
	  <tr>
	   <td class="align_center" width="20px"><c:out value="${transactionDetails.account_no}"></c:out>
	     <td class="align_center" width="20px"><c:out value="${transactionDetails.transaction_amount}"></c:out>
